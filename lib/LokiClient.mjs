...
const labelKey = labels =>
  JSON.stringify(
    Object.entries(labels).sort(
      // TODO coverage fails if this is a separate function
...
export class LokiClient {
  constructor(endPoint, opt) {
    ...
    this.opt = Object.assign({ extraLabels: {}, fetch }, opt || {});
  ...
  async flush() {
    const { streams, endPoint, opt } = this;
    ...
    const res = await opt.fetch(endPoint, {
      method: "POST",
